# Generated by Django 2.2.6 on 2023-04-04 16:41
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='group',
            name='slug',
            field=models.SlugField(unique=True, verbose_name='Параметр'),
        ),
        migrations.AlterField(
            model_name='group',
            name='title',
            field=models.CharField(max_length=200, verbose_name='Создание группы'),
        ),
        migrations.AlterField(
            model_name='post',
            name='author',
